            ...
            >
              <div className="single-footer-widget">
                ...
                <div className="footer-content">
                  <p>
                    En Gestoru ayudamos a gestionar y estructurar tu PYME o tu
                    negocio a través de nuestro software en la nube. Una suite
                    de herramientas para llevar a otro nivel tu emprendimiento.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="single-footer-widget">
                <div className="contact-box">
                  ...
                  <div className="info">
                    ...
                    <div className="link">
                      <a href="mailto:infogestoru@gmail.com">
                        infogestoru@gmail.com
                      </a>{" "}
                    </div>
                  </div>
                  <div className="info">
        ...
        <div className="container">
          <div className="footer-wrapper d-flex align-items-center justify-content-between">
            ...
            <ul className="social-links" data-wow-delay=".5s">
              <li>
                {" "}
                <a href="https://www.facebook.com/Gestoru" target="_blank">
              ...
              <li>
                {" "}
                <a
                  href="https://www.instagram.com/gestorusoftware/"
                  target="_blank"
                >
              ...
              <li>
                {" "}
                <a
                  href="https://www.linkedin.com/company/gestoru/"
                  target="_blank"
                >
              ...
              <li>
                {" "}
                <a
                  href="https://www.youtube.com/channel/UCX9A0q0OFbdVM4G9VZ_5HXA"
                  target="_blank"
                >
              ...
              <li>
                {" "}
                <a href="https://g.page/gestoru?share" target="_blank">
